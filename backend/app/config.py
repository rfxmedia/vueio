...
class Settings(BaseSettings):
    ...
    VUEIO_UPDATER_URL: str = ''
    VUEIO_UPDATER_TOKEN_FILE: str = ''
    VUEIO_HOST_STATE_PATH: str = ''
    VUEIO_HOST_CONFIG_PATH: str = ''
    VUEIO_HOST_DATA_PATH: str = ''
    VUEIO_HOST_POSTGRES_VOLUME: str = ''
